...
foreach dep in r2_bhar_1y r3_bhar_1y {
    ...
    forvalues s = 1/5 {
        ...
        * Year effects included from spec 4 onward
        ...
        outreg2 using "$out\Appendix_added_PooledRegressions_1yr.rtf", `rw' ///
            ctitle(`dep', spec `s') `kp' label ///
			adjr2 tstat ///
            addtext(Year Effects, `yearfe', Industry Fixed Effects, `indfe') ///
            title("Pooled regressions using one-year IPO returns")
    }
}


foreach dep in r2_bhar_5y r3_bhar_5y {
    ...
    forvalues s = 1/5 {
        ...
        * Year effects included from spec 4 onward
        ...
        outreg2 using "$out\Appendix_added_PooledRegressions_5yr.rtf", `rw' ///
            ctitle(`dep', spec `s') `kp' label ///
			adjr2 tstat ///
            addtext(Year Effects, `yearfe', Industry Fixed Effects, `indfe') ///
            title("Pooled regressions using five-year IPO returns")
    }
}
